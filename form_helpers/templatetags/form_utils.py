...
def render_field(field):
    ...
    # TODO: First look for a template, 'form_helpers/CharField.html', 'form_helpers/field.html'
    # Or use arguments to render, ie: form.field|render_field:"checkbox" > form_helpers/_checkbox.html
    return mark_safe(u"""
