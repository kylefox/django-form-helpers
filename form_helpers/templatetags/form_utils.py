...
def render_field(field):
    ...
    Markup is generated by rendering "form_utils/field.html"
    # TODO: Document default field template.

    You can customize the markup by overriding the "form_utils/field.html" template.
    # TODO: The template's context will be ______.
    ...
    which renders "form_utils/checkbox_field.html", and:
    ...
    FORM_FIELD_TEMPLATES = {
        Textarea: "form_utils/textbox.html",
        DateTimeWidget: "form_utils/datepicker.html"
    }
    ...
    # TODO: First look for a template, 'form_utils/CharField.html', 'form_utils/field.html'
    # Or use arguments to render, ie: form.field|render_field:"checkbox" > form_utils/_checkbox.html
    return mark_safe(u"""
    <div id="%(field_id)s" class="%(classes)s">
        %(errors)s
        <p class="widget">%(label)s %(field)s</p>
        %(help_text)s
    </div>
    """ % {
